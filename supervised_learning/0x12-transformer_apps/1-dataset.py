...
class Dataset:
    ...
    def encode(self, pt, en):
        ...
        pt_tokens = [vocab_size_pt] + self.tokenizer_pt.encode(pt.numpy().decode('utf-8')) + [vocab_size_pt + 1]
        en_tokens = [vocab_size_en] + self.tokenizer_en.encode(en.numpy().decode('utf-8')) + [vocab_size_en + 1]
